...
@section('content')
  @while(have_posts()) @php the_post() @endphp
    ...
    <div class="row contact ">
      <div class="col-lg-5 col-12 footer-left footer-content">
      ...
      <div class="col-lg-7 col-10 offset-1 footer-right footer-content footer-right-no-form">
        ...
        <p class="my-4">BOOK AN APPOINTMENT FOR MORE INFORMATION</p>
